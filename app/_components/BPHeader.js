          ...
          <div className="flex flex-col gap-0.5 sm:mt-2">
            <div className="flex items-center justify-between w-full">
              <div className="space-x-0.5">
                <label className="inline-block w-[3.8rem]">Code</label>
                <input
                  ref={docNumRef}
                  type="text"
                  ...
                  className={`border border-stone-400 focus:ring-2 focus:ring-yellow-600 focus:border-yellow-600 focus:border-0 focus:outline-none rounded-none w-[4.5rem] ${
                    isDocNumManuallyEntered
                      ? "bg-yellow-200"
                      : status === "Open"
                      ? "bg-white"
                ...
                <select
                  ...
                  className={`border border-stone-400 focus:ring-2 focus:ring-yellow-600 focus:border-yellow-600 focus:border-0 focus:outline-none rounded-none w-[3.8rem] ${
                    isDocNumManuallyEntered
                      ? "bg-yellow-200"
                      : status === "Open"
                      ? "bg-white"
