      ...
      if (loadingCount === 0) {
        try {
          ...
          if (copyToTriggered) {
            ...
            if (selectedItem) {
              let newBaseType;
              if (copyToFrom === "return request") newBaseType = 234000031;
              if (copyToFrom === "return") newBaseType = 16;
              if (copyToFrom === "ar down payment request") newBaseType = 203;
              if (copyToFrom === "ar invoice") newBaseType = 13;
